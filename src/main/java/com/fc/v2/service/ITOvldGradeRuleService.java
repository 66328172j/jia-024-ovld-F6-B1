...
/**
 * 超限吨位等级判定规则 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITOvldGradeRuleService {

    /** 按主键查询规则 */
    TOvldGradeRule selectTOvldGradeRuleById(Long id);
    ...
    List<TOvldGradeRule> listAvailable(Date at);
