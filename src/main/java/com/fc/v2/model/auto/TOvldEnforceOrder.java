...
/**
 * 治超执法工单对象 t_ovld_enforce_order
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_ovld_enforce_order")
@ApiModel(value = "TOvldEnforceOrder", description = "治超执法工单")
public class TOvldEnforceOrder implements Serializable {
