...
/**
 * 治超处理单对象 t_ovld_enforce_bill
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_ovld_enforce_bill")
@ApiModel(value = "TOvldEnforceBill", description = "治超处理单")
public class TOvldEnforceBill implements Serializable {
    ...
    /** 状态 0待处理 1已处理 2已办结 */
    @TableField("status")
    @ApiModelProperty(value = "状态 0待处理 1已处理 2已办结")
